let handler  = async (m, { conn }) => {
  if (m.sender == global.setting.nomorowner + '@s.whatsapp.net') throw 'Inimah Owner Aku Udah Pasti 100% Ganteng'
  if (m.sender == global.developer.nomor + '@s.whatsapp.net') throw 'Inimah developer Aku Udah Pasti 999999% Ganteng'
  conn.reply(m.chat,`“${random(ganteng)}”`, m)
}
