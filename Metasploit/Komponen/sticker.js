...
const tmp = path.join(__dirname, '../Cache/Sampah')
/**
 * Image to Sticker
...
function sticker6(img, url) {
  return new Promise(async (resolve, reject) => {
    ...
    const tmp = path.join(__dirname, `../Cache/Sampah/${+ new Date()}.${type.ext}`)
...
fs.watchFile(file, () => {
  fs.unwatchFile(file)
  console.log(chalk.redBright("Update 'Komponen/sticker.js'"))
