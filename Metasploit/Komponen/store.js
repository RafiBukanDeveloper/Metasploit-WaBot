...
/**
 * @param {import('@Rafi_Project/baileys').WASocket | import('@Rafi_Project/baileys').WALegacySocket}
 */
function bind(conn) {
    if (!conn.chats) conn.chats = {}
    /**
     * 
     * @param {import('@Rafi_Project/baileys').Contact[]|{contacts:import('@Rafi_Project/baileys').Contact[]}} contacts 
     * @returns 
     */
