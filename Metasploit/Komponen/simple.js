const baileysZu = "@Rafi_Project/baileys"
const {
...
`.trim()
    ...
    conn.processMessageStubType = async (m) => {
        /**
         * to process MessageStubType
         * @param {import('@Rafi_Project/baileys').proto.WebMessageInfo} m 
         */
        ...
        for (const message of m) {
            try {
                ...
                if (message.message?.[mtype]?.contextInfo?.quotedMessage) {
                    /**
                     * @type {import('@Rafi_Project/baileys').proto.IContextInfo}
                     */
                    let context = message.message[mtype].contextInfo
                    let participant = conn.decodeJid(context.participant)
                    const remoteJid = conn.decodeJid(context.remoteJid || participant)
                    /**
                     * @type {import('@Rafi_Project/baileys').proto.IMessage}
                     * 
                     */
        ...
        conn.sendMessage(m.chat, {
            ...
            contextInfo: {
                ...
                isForwarded: true,
                   ...
                   body: `Owner Bot: ` + setting.nomorowner,
...
fs.watchFile(file, () => {
  fs.unwatchFile(file)
  console.log(chalk.redBright("Update 'Komponen/simple.js'"))
